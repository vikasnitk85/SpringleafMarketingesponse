...
train <- read_csv("D:/Vikas_Agrawal/Education/Kaggle/Springleaf Marketing Response/Development/Data/train.csv")
test  <- read_csv("D:/Vikas_Agrawal/Education/Kaggle/Springleaf Marketing Response/Development/Data/test.csv")

feature.names <- names(train)[2:c(ncol(train)-1)]
