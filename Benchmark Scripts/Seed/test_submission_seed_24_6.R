...
for(i in names(train)) {
  train[, paste0(i, "_LOG")] <- log(train[, i])
  test[, paste0(i, "_LOG")] <- log(test[, i])
  if(sum(is.infinite(train[, paste0(i, "_LOG")])) > 0) train[which(is.infinite(train[, paste0(i, "_LOG")])), paste0(i, "_LOG")] <- NA
  if(sum(is.infinite(test[, paste0(i, "_LOG")])) > 0) test[which(is.infinite(test[, paste0(i, "_LOG")])), paste0(i, "_LOG")] <- NA
}
