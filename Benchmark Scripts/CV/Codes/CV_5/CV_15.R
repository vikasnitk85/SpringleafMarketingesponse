...
# Modify variable "VAR_0531"
train[, "VAR_0531"] <- as.numeric(substr(train[, "VAR_0531"], 1, 4))
test[, "VAR_0531"] <- as.numeric(substr(test[, "VAR_0531"], 1, 4))

# Drop variables with very high unique values (145171 out of 145231)
dropVars <- c("VAR_0227", "VAR_0228")
